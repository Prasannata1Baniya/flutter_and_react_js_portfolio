  ...
  return (
    <section className={styles.container}>
        <div className={styles.content}>
            ...
            <a href='mailto:prasannata250baniya@gmail.com' className={styles.contactBtn}>Contact me</a>
        </div>
        <img src={getImageUrl("hero/heroImage.png")} alt='' className={styles.heroImage}/>
